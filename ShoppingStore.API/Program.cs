...
{
    //options.UseSqlite(builder.Configuration["ConnectionStrings:IdentityDBConnectionString"]);
    options.UseNpgsql(builder.Configuration.GetConnectionString("ThangIdentityDBConnectionStringPostgres"));
});
