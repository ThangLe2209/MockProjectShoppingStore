...
namespace ShoppingStore.API.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public ProductsController(IProductRepository productRepository, IMapper mapper, IWebHostEnvironment webHostEnvironment,IResponseCacheService responseCacheService, IImageUploadService imageUploadService)
        {
        ...
        //public T ConvertToLocalTimeSingle<T>(T data) where T : BaseEntity
        //{
        //    data.CreatedDate = data.CreatedDate.ToLocalTime();
        //    data.UpdatedDate = data.UpdatedDate.ToLocalTime();
        //    return data;
        //}
        ...
        public async Task<ActionResult<IEnumerable<ProductDto>>> GetProducts(string? searchTerm)
        {
            ...
            //var result = ConvertToLocalTimeArray(_mapper.Map<IEnumerable<ProductDto>>(productEntities));
        ...
        public async Task<ActionResult> DeleteProduct(Guid productId)
        {
            try
            {
                ...
                await _productRepository.SaveChangesAsync();
                //_productRepository.DeleteProductImage(productImagePath); // handle localImage store only, leave behind because if can't not delete image success still fine but when delete product catch FK key constraint if we move this line to above then image will delete descpite of Product not
