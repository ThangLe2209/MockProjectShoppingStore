    ...
    public partial class InitialDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4965063c-40fe-40bd-b237-c7c90ff25f1c"), new DateTime(2024, 10, 19, 22, 42, 59, 0, DateTimeKind.Utc).AddTicks(1312), "Samsung is large brand in the world", "Samsung", "samsung", 1, new DateTime(2024, 10, 19, 22, 42, 59, 0, DateTimeKind.Utc).AddTicks(1312) },
                    { new Guid("9e4391a2-747a-4d22-bafb-2045f76002a0"), new DateTime(2024, 10, 19, 22, 42, 59, 0, DateTimeKind.Utc).AddTicks(1312), "Apple is large brand in the world", "Apple", "apple", 1, new DateTime(2024, 10, 19, 22, 42, 59, 0, DateTimeKind.Utc).AddTicks(1312) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("1280759c-7f99-4ce0-baa3-fb78bc2e6e58"), new Guid("4965063c-40fe-40bd-b237-c7c90ff25f1c"), 1233m, new Guid("0868e0f8-a3e3-4e46-aa2a-fc4351bbf8b5"), new DateTime(2024, 10, 19, 22, 42, 59, 0, DateTimeKind.Utc).AddTicks(1312), "Pc1234 is the Best", "1.jpg", "Pc1234", 1233m, 0, "pc1234", 0, new DateTime(2024, 10, 19, 22, 42, 59, 0, DateTimeKind.Utc).AddTicks(1312) },
                    { new Guid("eae3da18-ae13-45e2-80b5-cfa8ffeeea00"), new Guid("9e4391a2-747a-4d22-bafb-2045f76002a0"), 1233m, new Guid("a99e8fcd-a305-4780-b28b-c83512a3c2b6"), new DateTime(2024, 10, 19, 22, 42, 59, 0, DateTimeKind.Utc).AddTicks(1312), "Macbook is the Best", "1.jpg", "Macbook", 1233m, 0, "macbook", 0, new DateTime(2024, 10, 19, 22, 42, 59, 0, DateTimeKind.Utc).AddTicks(1312) }
                });
